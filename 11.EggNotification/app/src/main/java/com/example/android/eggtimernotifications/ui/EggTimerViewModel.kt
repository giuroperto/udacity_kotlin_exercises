...
//                commented so it won't send too many notifications -> when it starts is no needed
//                in order to trigger the notification -> notification manager
//                which is a system service which provides all functions exposed to notifications
//                get an instance of the notification from the system
//                api including the one we created
//                val notificationManager = ContextCompat.getSystemService(
//                    app,
//                    NotificationManager::class.java
//                ) as NotificationManager
//                call it with the message and the context
