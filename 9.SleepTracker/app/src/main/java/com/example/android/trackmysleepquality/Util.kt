...
//conversion function that we will be using later to display the sleep quality
...
//this function converts longToDateString formats our system time into a friendly string
...
// as this has nothing to do with the VM and could be used by any other class and might format our
// texts in many ways -> utility function

// this function returns a type Spanned which is an HTML formatted string
// inside the function we use CDATA to add HTML and labels and format the date
